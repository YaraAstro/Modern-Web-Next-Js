...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('miakinkaid@gmail.com')
    setCopied(true)
  }
...

          {
            id === 6 && (
              <div className="mt-5 relative">
                ...
                <MagicButton title={copied ? 'Email Copied' : 'Copy My Email'} icon={<IoCopyOutline />} position={"left"} handleClick={handleCopy} otherClasses="!bg-[#161A31]" />
              </div>
            )
          }
